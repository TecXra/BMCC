...
export default function Dashboard() {
    ...
    useEffect(() => {
      ...
      const irtDeptBudgetPercentageWidth = irtDeptBudgetPercentage.toFixed(2) + '%';
    ...
    }, [irtDeptBudget,dept2Budget,dept3Budget,dept4Budget,previousYearBudget]);
  ...
  return (
    <Layout>
      <div className="flex justify-between">
        ...
        <div className="flex mt-[40px]">
          <div className="mr-[10px]">
            <HollowButton text={"Spend Down"} onClick={()=>{router.push('/spend-down')}}/>
          </div>
          <div>
            <FilledButton text={"View Budget"} onClick={()=>{router.push('/budget-details')}}/>
          </div>
        </div>
      </div>
      ...
      <div className={styles.budget_used_container}>
        ...
        <div className="flex">
          <div className="mt-[-43px]">
            <CustomProgress value={92.37}/>
          </div>
          <div className="flex">
            <div
              className={[styles.budget_used_card, "ml-[20px] mr-[9px]"].join(
                " "
              )}
            >
              <div>
              ...
              <div onClick={()=>{handleBudgetCardClick(budget2023)}}>
                <picture>
                  <img
            ...
            <div className={styles.budget_used_card}>
              <div>
              ...
              <div onClick={()=>{handleBudgetCardClick(budget2022)}}>
                <picture>
                  <img
                    src="/card-right-arrow.png"
                     className="h-[20px] w-[20px] cursor-pointer"
      ...
      <div className="flex mt-[38px]">
        <div className="flex" style={irtDeptWidthStyle}>
          ...
          <div className="mx-[3px] w-[100%]">
            ...
            <h3 className={styles.progress_price}>${irtDeptBudget.toLocaleString()}</h3>
        ...
        <div className="flex" style={dept2WidthStyle}>
          ...
          <div className="mx-[3px] w-[100%]">
            ...
            <h3 className={styles.progress_price}>${dept2Budget.toLocaleString()}</h3>
        ...
        <div className="flex" style={dept3WidthStyle}>
          ...
          <div className="mx-[3px] w-[100%]">
            ...
            <h3 className={styles.progress_price}>${dept3Budget.toLocaleString()}</h3>
        ...
        <div className="flex" style={dept4WidthStyle}>
          ...
          <div className="ml-[3px] w-[100%]">
            ...
            <h3 className={styles.progress_price}>${dept4Budget.toLocaleString()}</h3>
      ...
      {/* budget by department section */}
       ...
       <div>
              <h1 className={styles.department_budget_title}>
